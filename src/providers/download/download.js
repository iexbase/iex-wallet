...
var DownloadProvider = /** @class */ (function () {
     ...
     * @param logger - Logger
     */
    function DownloadProvider(logger) {
        this.logger = logger;
        this.logger.debug('DownloadProvider initialized');
    }
    DownloadProvider.prototype.download = function (ew, fileName) {
        var _this = this;
        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            var a, blob, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, timer(1000).toPromise()];
                    case 1:
                        _a.sent();
                        a = document.createElement('a');
                        blob = this.newBlob(ew, 'text/plain;charset=utf-8');
    ...
    DownloadProvider.prototype.newBlob = function (data, datatype) {
        var out;
        try {
